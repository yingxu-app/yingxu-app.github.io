/* One language state, one navigation pattern, one brand icon for YINGXU v24. */
(() => {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    window.setTimeout(() => {
      ...
      if (document.querySelector('.brand-shell')) translateHome(language);

      // Scroll animation writes a few status strings after the initial render.
      if (language === 'en' && document.querySelector('.brand-shell')) {
