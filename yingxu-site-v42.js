/* One language state, original homepage dropdowns, and one brand icon for YINGXU v36. */
(() => {
  ...
  const englishText = {
    ...
    '下载 macOS v1.0.6 →':'Download macOS v1.0.6 →',
    ...
    '下载 .zip 并拖入 Applications':'Download the .zip and drag it into Applications', '从启动台打开影序':'Open YINGXU from Launchpad',
  ...
  // Homepage navigation, live workflow states, and footer use short text nodes
  // that are not part of the larger editorial copy above.
  Object.assign(englishText, {
    '跳到主要内容': 'Skip to main content',
    '介绍导览': 'Guide', '功能介绍': 'Features', '核心能力一览': 'Core capabilities',
    '使用方式': 'How it works', '快速上手指引': 'Quick start guide',
    '常见问题': 'FAQ', '疑问解答': 'Answers to common questions',
    '安装指引': 'Installation', '下载安装': 'Download and install',
    '版本动态': 'Release notes', '关于项目': 'About the project',
    '了解更多': 'Learn more', '最新博客': 'Latest notes', '阅读文章': 'Read articles',
    '体验导览': 'Product tour', '在线体验': 'Explore online',
    '免费下载': 'Free download', '进入发布页': 'Open releases',
    '已可下载': 'Available now', '正在准备发布包': 'Preparing release',
    '源码下载': 'Source code', '获取发布版本': 'Get the release',
    '下载 macOS 版': 'Download for macOS', '查看工作流': 'View workflow',
    '查看下载与校验': 'Download and verify',
    '相机已识别': 'Camera recognized', '等待取卡': 'Ready to remove the card',
    '识别 / SCAN': 'SCAN', '备份 / BACKUP': 'BACKUP', '校验 / VERIFY': 'VERIFY',
    '识别中': 'Scanning', '设备与素材': 'Device and media',
    '正在读懂这张卡': 'Understanding this card', '识别来源、拍摄线索与文件类型。': 'Reading source, capture context, and file types.',
    '备份中': 'Backing up', '路径与进度': 'Destination and progress',
    '正在送往正确的位置': 'Sending files to the right place', '按项目归档，并复制到你选择的备份目标。': 'Archiving by project and copying to your selected destination.',
    '校验完成': 'Verified', '历史已写入': 'History recorded',
    '这次备份可以确认': 'This backup is confirmed', '文件校验完成；以后找回从清晰线索开始。': 'Verification is complete; recovery starts from clear context.',
    '正在取出 SD 卡': 'Removing the SD card', '素材仍在原卡': 'Original media remains on the card',
    '正在安全拷贝': 'Copying safely', '文件流向你的归档': 'Files are flowing into your archive',
    '正在校验文件': 'Verifying files', '逐份确认完整': 'Checking every file',
    '归档已经完成': 'Archive complete', '现在，它找得到': 'Now it is findable',
    '影序 Pocket': 'YINGXU Pocket', '当前 macOS': 'Current macOS',
    '独立开发者': 'Independent developer', '上海立达学院在读': 'Shanghai Lida University student'
  });
  ...
  const renderNavigation = language => {
    ...
    nav.innerHTML = `
      ...
      <a href="guide-v42.html">${english ? 'Guide' : '导览'}</a>
      <a href="download-v42.html">${english ? 'Download' : '下载'}</a>
