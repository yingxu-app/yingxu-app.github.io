(() => {
  ...
  document.querySelectorAll('a[href*="-v18.html"],a[href*="-v19.html"],a[href*="-v20.html"],a[href*="-v21.html"],a[href*="-v22.html"]').forEach((link) => {
    link.href = link.getAttribute('href').replace(/-v(?:18|19|20|21|22)\.html/g, '-v23.html');
  });
})();
