/* One language state, original homepage dropdowns, and one brand icon for YINGXU v35. */
(() => {
  ...
  const renderNavigation = language => {
    ...
    nav.innerHTML = `
      ...
      <a href="guide-v35.html">${english ? 'Guide' : '导览'}</a>
      <a href="download-v35.html">${english ? 'Download' : '下载'}</a>
