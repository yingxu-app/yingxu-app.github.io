/* v41 is the single public release-link authority. Older visual pages remain
   available as rollback copies. v1.0.30 is the verified public macOS release. */
(() => {
  const stableVersion = '1.0.30';
  const stableSha256 = '062f8301490ae697261f5372ae7ccef7e67c885fef773b934d7825812fb21519';
  ...
  document.querySelectorAll('a[href]').forEach((link) => {
    ...
    if (/-v(?:19|21|22|23|24|26|27|28|29|31|32|33|34|35|36|37|38|39)\.html/.test(raw)) {
      link.setAttribute('href', raw.replace(/-v(?:19|21|22|23|24|26|27|28|29|31|32|33|34|35|36|37|38|39)\.html/g, '-v41.html'));
    }
  });
